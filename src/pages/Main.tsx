		...
		<main className="container mx-auto px-4 py-8 flex-grow">
			<div className="max-w-4xl mx-auto p-4">
				...
				<div className="space-y-8 text-gray-700">
					...
					<p className="leading-relaxed">
						Os salários variam entre R$ <span className="text-[#1351B4]">2.384,22</span> e R$ <span className="text-[#1351B4]"> 3.456,13</span>, dependendo da região e da modalidade de
						atuação.
					</p>
					...
					<div className="mt-12 border border-gray-200 overflow-hidden">
						...
						<div className="p-6 text-center">
							...
							<p className="text-gray-600">Prazo final: 25/05/2025</p>
						</div>
					</div>
