        ...
        {step >= 2 && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <button
              ...
              className="w-full bg-green-600 text-white text-sm font-medium py-4 rounded-lg hover:bg-green-700 transition-colors mb-2"
            >
            ...
            <p className="text-sm text-gray-500 text-center mb-4">
             ...
             <button
              ...
              className="w-full bg-red-600 text-white text-sm font-medium py-4 rounded-lg hover:bg-green-700 transition-colors mb-5"
            >
